...
const About = () => {
  return (
    ...
    <h1>About</h1>
    <div>
      <p className='info-para'> <span className='bullets'> <CgShapeSquare /> </span>  A 21 year old techie pursuing bachelor of technology in computer science engineering.</p>
