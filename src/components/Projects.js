...
const Projects = () => {
  return (
    <section className='project' id='projects'>
        ...
        <div>
            <h3>Soundli</h3>
            <p>A music app similar to Spotify, with enhanced UI and performance. It uses Rapid API for data fetching and playing music. Tailwind CSS is used for styling.</p>
            <div><a href='https://github.com/urmil22/soundli-music-app'rel="noreferrer" target='_blank'><FaGithub /></a> 
...
The main aim was building UI and form validation.</p>
            <div><a href='https://github.com/urmil22/Chainwhiz-intern-task'rel="noreferrer" target='_blank'><FaGithub /></a> 
        ...
        <div>
            ...
            <div><a href='https://github.com/urmil22/coin-cellar'rel="noreferrer" target='_blank'><FaGithub /></a> 
