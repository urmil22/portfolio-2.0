    ...
    <section className='project' id='projects'>
        <h1>Projects</h1>
            <div className='project-grid'>
                <div>
            <h3> <a className='project-title' href='https://creative-writes-two.vercel.app/'>Creative Minds</a> </h3>
        ...
        <div>
            <h3><a className='project-title' href='https://interactive-details-card-form.netlify.app/'> Interactive card details form </a></h3>
...
The main aim was building UI and form validation.</p>
        ...
        <div>
            <h3> <a className='project-title' href='https://urmil-expense-tracker.netlify.app/'> Expense Tracker </a></h3>
        ...
        <div>
            <h3> <a className='project-title' href='https://urmil-chat-app.netlify.app/'> Chat app </a></h3>
        ...
        <div>
            <h3> <a className='project-title' href='https://urmil-recipe-app.netlify.app/'> Cooking with React </a></h3>
        ...
        <div>
            <h3><a className='project-title' href='https://urmil-stock-calculator.netlify.app/'>Stock Calculator</a></h3>
        ...
        <div>
            <h3><a className='project-title' href='https://soundli-music-app.netlify.app/'> Soundli </a></h3>
        ...
        <p className='more-projects' style={{color:'var(--secondary-color)'}}>More projects on my <a style={{fontSize: '16px'}} href='https://github.com/urmil22'>GitHub</a></p>
    </section>
  )
}
